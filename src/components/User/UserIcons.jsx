 ...
 export const UserIcons = ({ id}) => {
       switch (id) {
           case 'icon-user_logout':
               return (
                   <svg id="icon-user_logout" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" >
                       <path stroke-width="1.778" d="M27.209 11.682a.362.362 0 0 1 .511 0l2.799 2.799a2.24 2.24 0 0 1 0 3.162l-2.799 2.799a.357.357 0 0 1-.51 0 .36.36 0 0 1 0-.51l3.508-3.509H13.563a.36.36 0 1 1 0-.722h17.155l-3.508-3.509a.36.36 0 0 1 0-.51zM21.736 24.5V27a4.117 4.117 0 0 1-4.111 4.111H5.062A4.117 4.117 0 0 1 .951 27V5A4.117 4.117 0 0 1 5.062.889h12.563A4.117 4.117 0 0 1 21.736 5v2.5a.36.36 0 1 1-.722 0V5a3.392 3.392 0 0 0-3.389-3.389H5.062A3.392 3.392 0 0 0 1.673 5v22a3.392 3.392 0 0 0 3.389 3.389h12.563A3.392 3.392 0 0 0 21.014 27v-2.5a.361.361 0 0 1 .722 0z"/>
                   </svg>
               );
           case 'icon-user_red':
               return (
                   <svg id="icon-user_red" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" >
           ...
           case 'icon-user_done':
               return (
                   <svg id="icon-user_done" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" >
           ...
           case 'camera':
               return (
                   <svg id="camera" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" >
           ...
           case 'icon-user_plus':
               return (
                   <svg id="icon-user_plus" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" >
                        <path stroke-width="2" d="M12 20v-8m0 0V4m0 8h8m-8 0H4"/>
                   </svg>
           );
