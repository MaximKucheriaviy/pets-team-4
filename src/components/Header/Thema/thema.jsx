...
<Box>
       ...
       <Btn onClick={closeHandler}><svg fill="current" height="20px" width="20px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
  <g>
    <g>
      ...
      <path d="m102.5,131.4c8,8 20.9,8 28.9,0 8-8 8-20.9 0-28.9l-19.7-19.7c-8-8-20.9-8-28.9,0-8,8-8,20.9 0,28.9l19.7,19.7z"/>
        ...
        <BtnT onClick={addHandler}><svg fill="current" height="20px" width="20px" version="1.1"  viewBox="0 0 512 512" >
  <g>
